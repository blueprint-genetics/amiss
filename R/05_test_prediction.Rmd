...
all_table <- Reduce(function(x, y) merge(x, y, by = c("method", "model_index", "test_realization")), tables)
colnames(all_table) <- c("method", "model_index", "test_realization", names(tables))
all_table
```
