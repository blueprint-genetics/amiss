...
# RF MCC
grid.arrange(
  ggplot(perf_table, aes(x = method, y = rf_mcc)) + geom_boxplot() + ggtitle("MCC of random forest classifier"),
  ggplot(perf_over_test_mean_table, aes(x = method, y = rf_mcc)) + geom_boxplot() + ggtitle("MCC of random forest classifier", subtitle = "Aggregated over test set realizations"),
  ggplot(perf_over_train_mean_table, aes(x = method, y = rf_mcc)) + geom_boxplot() + ggtitle("MCC of random forest classifier", subtitle = "Aggregated over training set realizations")
)

# RF AUC-ROC
grid.arrange(
  ggplot(perf_table, aes(x = method, y = rf_auc)) + geom_boxplot() + ggtitle("AUC-ROC of random forest classifier"),
  ggplot(perf_over_test_mean_table, aes(x = method, y = rf_auc)) + geom_boxplot() + ggtitle("AUC-ROC of random forest classifier", subtitle = "Aggregated over test set realizations"),
  ggplot(perf_over_train_mean_table, aes(x = method, y = rf_auc)) + geom_boxplot() + ggtitle("AUC-ROC of random forest classifier", subtitle = "Aggregated over training set realizations")
)

# LR MCC
grid.arrange(
  ggplot(perf_table, aes(x = method, y = lr_mcc)) + geom_boxplot() + ggtitle("MCC of logistic regression classifier"),
  ggplot(perf_over_test_mean_table, aes(x = method, y = lr_mcc)) + geom_boxplot() + ggtitle("MCC of logistic regression classifier", subtitle = "Aggregated over test set realizations"),
  ggplot(perf_over_train_mean_table, aes(x = method, y = lr_mcc)) + geom_boxplot() + ggtitle("MCC of logistic regression classifier", subtitle = "Aggregated over training set realizations")
)

# RF AUC-ROC
grid.arrange(
  ggplot(perf_table, aes(x = method, y = lr_auc)) + geom_boxplot() + ggtitle("AUC-ROC of logistic regression classifier"),
  ggplot(perf_over_test_mean_table, aes(x = method, y = lr_auc)) + geom_boxplot() + ggtitle("AUC-ROC of logistic regression classifier", subtitle = "Aggregated over test set realizations"),
  ggplot(perf_over_train_mean_table, aes(x = method, y = lr_auc)) + geom_boxplot() + ggtitle("AUC-ROC of logistic regression classifier", subtitle = "Aggregated over training set realizations")
)
```