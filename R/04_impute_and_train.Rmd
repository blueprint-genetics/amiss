...
rf_bests <- select_best(rf_models, imputations, imputation_hyperparameter_grids, performance_function = extract_oob_performance, TRUE)
lr_bests <- select_best(lr_models, imputations, imputation_hyperparameter_grids, performance_function = extract_mcc_performance, FALSE)
```
