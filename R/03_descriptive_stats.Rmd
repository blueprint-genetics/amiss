...
training_set <- read.csv(here("data", "preprocessed_w_categorical_vars_training_data.csv"), row.names = 1, as.is = TRUE)
outcome <- read.csv(here("data", "training_outcomes.csv"), row.names = 1)[,1]
...
```{r}
write(capture.output(sessionInfo()), here("03_descriptive_stats_sessioninfo.txt"))
```
