...
```{r}
conseq_by_clnsig <- table(training_set$Consequence.x, training_set$CLNSIG, useNA = "always")
conseq_by_clnsig <- cbind(conseq_by_clnsig, ALL_ = rowSums(conseq_by_clnsig))
conseq_by_clnsig <- rbind(conseq_by_clnsig, ALL_ = colSums(conseq_by_clnsig))
conseq_by_clnsig
```
## Choose features
```{r}
