...
table_with_margin(training_set$Consequence.x, training_set$CLNSIG, useNA = "always")
table_with_margin(training_set$Consequence.x, training_set$outcome, useNA = "always")
```
Indeed they do not. One might consider e.g. removing all stop-gain variants in the test set to avoid biasing the result, as the 
...
for (cat_feat in categorical_features) {
  table(training_set[, cat_feat, drop = FALSE], dnn = cat_feat, useNA = "always") %>% print
  cat("\n")
}
```
