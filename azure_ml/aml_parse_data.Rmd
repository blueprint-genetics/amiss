...
for (child_run_id in child_run_ids){
  ...
  download_files_from_run(child_run_iter, "outputs/data/", output_directory = "../")

}

# TODO: I don't know how that csv gets involved, get rid of it and this check
output_files <- Filter(Negate(function(x) (grepl(".log$", x) | grepl(".csv$", x))), list.files("../outputs/data/", full.names = TRUE))
